...
class connect_pg:
    ...
    def commit_pg_txn(query: str):
        ...
        try:
            ...
            #print("Error while fetching details from Secrects Manager", error) 
            ...
            try:             
                ...
                try:
                    ...
                    #print("Error while Executing the query in PostgreSQL", error, query) 
                    ...
                    if query.upper().startswith('SELECT'):
                        try:
                            ...
                            #print("Error while Fetching records from PostgreSQL for the query", error, query) 
